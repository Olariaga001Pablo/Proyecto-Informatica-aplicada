...
contextBridge.exposeInMainWorld('utilAPI', {
    // Función para invocar el cálculo solar en el proceso principal
    calcularSistema: (potenciaDemandaWatts, potenciaPanelWatts) => 
        ipcRenderer.invoke('calcular-sistema', potenciaDemandaWatts, potenciaPanelWatts),

    // Función de log para depuración (opcional)
